...
class Cooldown(commands.Cog):
    ...
    async def cd(self, ctx, user: discord.Member = None):
        ...
        battle_cooldown = self.bot.get_command("battle").get_cooldown_retry_after(ctx)
        ...
        battle_time = self.format_cooldown_time(battle_cooldown)
        ...
        embed.add_field(name="", value=f"<:hclock2:1136747860478664765> **Battle** : {'✅' if battle_cooldown == 0 else battle_time}", inline=False)
